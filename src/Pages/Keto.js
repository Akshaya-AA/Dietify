...
import kd4 from './images/k s  chocolate fat bombs.jpg';
import kd5 from './images/k de keto pumpkin pie.jpg';
import kd6 from './images/k sample cobb salad.jpg';
...
function KetoPage() {
  ...
  const ketoItems = [
    { title: 'Cheese Omelette', price: '$5.99', image: kd1, description: 'Fluffy cheese omelette perfect for a keto breakfast.', rating: 4 },
    { title: 'Cauliflower Rice Stir Fry', price: '$6.49', image: kd2, description: 'Low-carb stir fry with cauliflower rice and veggies.', rating: 5 },
    { title: 'Cauliflower Crust Pizza', price: '$7.99', image: kd3, description: 'Keto-friendly pizza with a crispy cauliflower crust.', rating: 4 },
    { title: 'Chocolate Fat Bombs', price: '$4.99', image: kd4, description: 'Delicious chocolate bites loaded with healthy fats.', rating: 3 },
    { title: 'Pumpkin Pie', price: '$5.49', image: kd5, description: 'Rich and creamy keto pumpkin pie with a nutty crust.', rating: 5 },
    { title: 'Cobb Salad', price: '$6.99', image: kd6, description: 'Classic Cobb salad with avocado, bacon, and boiled eggs.', rating: 4 },
  ];
