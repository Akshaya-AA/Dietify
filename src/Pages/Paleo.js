...
import pd4 from './images/p s zucchini chips.jpg';
import pd5 from './images/p de carrot ake.jpg';
import pd6 from './images/p sample avocado and bacon egg cups.jpg';
...
function PaleoPage() {
  ...
  const paleoItems = [
    { title: 'Sweet Potato Hash', price: '$5.99', image: pd1, description: 'A delicious hash made with sweet potatoes.', rating: 4 },
    { title: 'Roasted Salmon with Greens', price: '$6.49', image: pd2, description: 'A nutritious and flavorful salmon dish.', rating: 5 },
    { title: 'Grilled Steak vegies', price: '$7.99', image: pd3, description: 'A juicy grilled steak roasted with vegies. ', rating: 4 },
    { title: 'Zucchini Chips', price: '$4.99', image: pd4, description: 'Crispy and healthy zucchini chips snacks.', rating: 3 },
    { title: 'Carrot Cake', price: '$5.49', image: pd5, description: 'A carrot cake made with almond flour.', rating: 5 },
    { title: 'Avocado Bacon Egg Cups', price: '$6.99', image: pd6, description: 'A   baked eggs in avocado halves, topped with crispy bacon.', rating: 4 },
  ];
